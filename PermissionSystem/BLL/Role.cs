...
namespace PermissionSystem.BLL
{
	public partial class Role : IRole
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public PermissionSystem.Model.Role GetModelByCache(long role_id)
		{
			...
			return (PermissionSystem.Model.Role)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<PermissionSystem.Model.Role> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<PermissionSystem.Model.Role> DataTableToList(DataTable dt)
		{
			List<PermissionSystem.Model.Role> modelList = new List<PermissionSystem.Model.Role>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				PermissionSystem.Model.Role model;
